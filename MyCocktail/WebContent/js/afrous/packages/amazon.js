...
var stylesheet = u+'/packages/amazon_ecs4_itemsearch.xsl';


var amazon = new afrous.UnitActionPackage('Services.Amazon', {
  label : 'Amazon',
  icon : 'http://www.amazon.com/favicon.ico'
});

amazon.register(new afrous.UnitAction({
  type : 'ItemSearch',
...
afrous.packages.register(amazon, 'amazon.js');
