 ...
 */
var ArrayFreebaseSearchWidget = function() {
  ArrayFreebaseSearchWidget.superclass.constructor.apply(this, arguments);
}

Ext.extend(ArrayFreebaseSearchWidget, ArrayBindingWidget, {
...
afrous.editor.widgets.register('Services.Freebase.FreebaseSearch', ArrayFreebaseSearchWidget);
